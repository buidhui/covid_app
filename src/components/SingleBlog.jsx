...
function SingleBlog(props) {
    return (
        ...
        <div className="body_wrapper">
          ...
          <div className="mobile_canvus_menu">
            ...
            <div className="menu_btm">
              <a className="green_btn" href="#"><i className="linearicons-pulse" /> Symptom Checker</a>
            </div>
          </div>
          <header className="header_area white_header">
            ...
            <div className="main_menu">
                  ...
                  <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="nav navbar-nav ml-auto">
                      ...
                      <li className="dropdown submenu">
                        <a className="dropdown-toggle" data-toggle="dropdown" href="prevention.html" role="button" aria-haspopup="true" aria-expanded="false">Prevention </a>
                        <i className="linearicons-chevron-down mobile_dropdown" aria-hidden="true" data-toggle="dropdown" />
                        <ul className="dropdown-menu">
                          <li className="dropdown submenu">
                            <a className="dropdown-toggle" data-toggle="dropdown" href="symptom.html" role="button" aria-haspopup="true" aria-expanded="false">Symptoms
                              <i className="linearicons-chevron-right mobile_dropdown" aria-hidden="true" data-toggle="dropdown" />
                            </a>
                            <ul className="dropdown-menu">
                              <li><a href="symptom.html">Typical Symptoms</a></li>
                              <li><a href="symptom-checker.html">Symptom Checker</a></li>
                      ...
                      <li className="dropdown submenu">
                        ...
                        <ul className="dropdown-menu">
                          ...
                          <li><a href="typography.html">Typhography</a></li>
                          <li className="dropdown submenu">
                            <a className="dropdown-toggle" data-toggle="dropdown" href="search.html" role="button" aria-haspopup="true" aria-expanded="false">Search
                              <i className="linearicons-chevron-right mobile_dropdown" aria-hidden="true" data-toggle="dropdown" />
                            </a>
                            <ul className="dropdown-menu">
                              <li><a href="search.html">Search</a></li>
                      ...
                      <li className="dropdown submenu active">
                        <a className="dropdown-toggle" data-toggle="dropdown" href="blog.html" role="button" aria-haspopup="true" aria-expanded="false">Blog
                        </a>
                        <i className="linearicons-chevron-down mobile_dropdown" aria-hidden="true" data-toggle="dropdown" />
                        <ul className="dropdown-menu">
                          <li><a href="blog.html">Blog</a></li>
                    ...
                    <ul className="nav navbar-nav navbar-right">
                      <li className="checker_btn">
                        <a href="#"><i className="linearicons-pulse" /> Symptom Checker</a>
                      </li>
                    </ul>
                  </div>
                </nav>
              ...
              <div className="right_burger">
                <ul className="nav">
                  <li>
                    <div className="search_btn" data-toggle="modal" data-target="#exampleModal">
            ...
            <div className="info_sidebar_inner">
              ...
              <form action="#" className="appoinment_form js-form">
                <div className="row">
                  <div className="col-lg-12">
                    <div className="form-group">
                      <input className="form-control" type="text" id="a_name" name="a_name" placeholder required />
                      <label><i className="linearicons-user" />Your Name</label>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group">
                      <input className="form-control" type="text" id="a_email" name="a_email" placeholder required />
                      <label><i className="linearicons-envelope-open" />Your Email
                        Address</label>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group">
                      <input className="form-control" type="text" id="a_number" name="a_number" placeholder required />
                      <label><i className="linearicons-telephone" />Your Phone
                        Number</label>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group">
                      <textarea name="a_message" id="a_message" cols={30} rows={10} className="form-control" required defaultValue={""} />
                      <label><i className="linearicons-document" />Your Message</label>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="form-group checkbox_field">
                      <div className="checkbox">
                        <input type="checkbox" defaultValue="None" id="a_policy" name="check" />
                        <label className="l_text" htmlFor="a_policy">I accept the <span>Privacy
                            Policy</span></label>
                      </div>
                      <button type="submit" className="green_btn" name="appoinment" id="appoinment" value="appoinment" data-value="appoinment">
                        Submit
                      </button>
                    </div>
                  </div>
                ...
                <div className="success-message">
                  <i className="fa fa-check text-primary" /> Thank you!. Your message
                  is successfully sent...
                </div>
                <div className="error-message">We're sorry, but something went wrong</div>
              </form>
          ...
          <section className="single_blog_img">
            <div className="container">
              <div className="single_blog_text">
                <a className="tag" href="#">Quarantine</a>
                <h2>How to treat COVID-19 coronavirus at home?</h2>
                <ul className="nav">
                  <li><a href="#"><i className="linearicons-calendar-full" />Apr 18, 2020 </a></li>
                  <li><a href="#"><i className="linearicons-bubbles" />22</a></li>
                  <li><a href="#">by Sheryl Smith</a></li>
                  <li><a href="#"><i className="linearicons-radio-button" style={{color: '#01cfbe'}} />4 min
                      read</a></li>
                </ul>
              </div>
            </div>
                ...
                <div className="col-lg-9">
                  <div className="single_blog_text_inner">
                    ...
                    <div className="secand_part">
                      ...
                      <img className="img-fluid" src="assets/images/blog/single-blog-1.jpg" alt="" />
                      ...
                      <div className="row m-0 justify-content-between">
                        ...
                        <div className="right">
                          <ul className="nav">
                            ...
                            <li><a href="#"><i className="fas fa-envelope-open-text" /></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    <div className="post_navigation row">
                      <div className="col-6">
                        <a href="#"><i className="linearicons-arrow-left" /> Previous post</a>
                        <h4>What can I do under the new rules?</h4>
                      </div>
                      <div className="col-6 text-right">
                        <a href="#">Next post <i className="linearicons-arrow-right" /></a>
                    ...
                    <div className="post_author">
                      <div className="media">
                        <div className="d-flex">
                          <img className="rounded-circle" src="assets/images/author.png" alt="" />
                        </div>
                        <div className="media-body">
                          <h4>Sheryl Smith</h4>
                          ...
                          <a className="post" href="#"><i className="linearicons-papers" /> Articles</a>
                          <ul className="nav">
                            <li><a href="#"><i className="fab fa-facebook" /></a></li>
                            <li><a href="#"><i className="fab fa-twitter" /></a></li>
                            <li><a href="#"><i className="fab fa-instagram" /></a></li>
                            <li><a href="#"><i className="fab fa-linkedin-in" /></a></li>
                            <li><a href="#"><i className="fab fa-medium-m" /></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    <div className="s_comment_list">
                      ...
                      <div className="s_comment_list_inner">
                        <div className="media">
                          <div className="d-flex">
                            <img className="rounded-circle" src="assets/images/comment/comment-1.png" alt="" />
                          </div>
                          <div className="media-body">
                            <a href="#">
                            ...
                            <h6><i className="linearicons-clock3" /> 3 hours ago</h6>
                            <a className="text_btn" href="#">Reply <i className="linearicons-arrow-right" /></a>
                            <div className="media">
                              <div className="d-flex">
                                <img className="rounded-circle" src="assets/images/comment/comment-2.png" alt="" />
                              </div>
                              <div className="media-body">
                                <a href="#">
                                  <h4>Robert Kane</h4>
                                ...
                                <h6><i className="linearicons-clock3" /> 22 mins ago</h6>
                                <a className="text_btn" href="#">Reply
                                  <i className="linearicons-arrow-right" />
                                </a>
                                <div className="media">
                                  <div className="d-flex">
                                    <img className="rounded-circle" src="assets/images/comment/comment-3.png" alt="" />
                                  </div>
                                  <div className="media-body">
                                    <a href="#">
                                      <h4>Liu Jackson</h4>
                                    ...
                                    <h6><i className="linearicons-clock3" /> 8 mins ago</h6>
                                    <a className="text_btn" href="#">Reply <i className="linearicons-arrow-right" /></a>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="media">
                          <div className="d-flex">
                            <img className="rounded-circle" src="assets/images/comment/comment-4.png" alt="" />
                          </div>
                          <div className="media-body">
                            <a href="#">
                            ...
                            <h6><i className="linearicons-clock3" /> 1 day ago</h6>
                            <a className="text_btn" href="#">Reply <i className="linearicons-arrow-right" /></a>
                            <div className="media">
                              <div className="d-flex">
                                <img className="rounded-circle" src="assets/images/comment/comment-5.png" alt="" />
                              </div>
                              <div className="media-body">
                                <a href="#">
                                  <h4>Naomi Hill</h4>
                    ...
                    <div className="comment_box">
                      ...
                      <form className="row contact_us_form appoinment_form" action="http://paul-themes.com/html/covid-19/contact_process.php" id="contactForm" noValidate="novalidate">
                        <div className="col-md-6">
                          <div className="form-group">
                            <input className="form-control" type="text" id="name" name="name" placeholder />
                            <label><i className="linearicons-user" />Your Name</label>
                          </div>
                        </div>
                        <div className="col-md-6">
                        ...
                        <div className="col-lg-12">
                          <div className="form-group">
                            <input className="form-control" type="text" id="subject" name="subject" placeholder />
                            <label><i className="linearicons-document" />
                              Subject</label>
                          </div>
                        </div>
                        <div className="col-lg-12">
                          <div className="form-group">
                            ...
                            <label><i className="linearicons-pencil4" />Your Message</label>
                          </div>
                        </div>
                        <div className="col-lg-12">
                          <div className="form-group checkbox_field">
                            <div className="checkbox">
                              <input type="checkbox" defaultValue="None" id="policy" name="check" />
                              <label className="l_text" htmlFor="policy">Save my name, email, and website in
                  ...
                  <div className="right_sidebar">
                    <aside className="right_widget ct_widget">
                      ...
                      <ul className="nav flex-column">
                        <li><a href="#"><i className="linearicons-arrow-right" />Political News
                            <span>(17)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Medicine
                            <span>(29)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Economic Effects
                            <span>(8)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Prevention
                            <span>(33)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Education
                            <span>(27)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Quarantine
                            <span>(9)</span></a></li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Health <span>(18)</span></a>
                        </li>
                        <li><a href="#"><i className="linearicons-arrow-right" />Travel <span>(5)</span></a>
                        </li>
                      </ul>
                    </aside>
                    <aside className="right_widget subs_widget">
                      ...
                      <div className="subs_text">
                        ...
                        <a className="subs_btn" href="#">Subscribe</a>
                      </div>
                    </aside>
                    ...
                    <aside className="right_widget wash_widget">
                      ...
                      <a className="text_btn" href="#">View more <i className="linearicons-arrow-right" /></a>
                    </aside>
                    <aside className="right_widget archive_widget ct_widget">
                      ...
                      <ul className="nav flex-column">
                        <li><a href="#"><i className="linearicons-calendar-text" />Apr 2020
                            <span>(49)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Marc 2020
                            <span>(40)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Feb 2020
                            <span>(32)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Jan 2020
                            <span>(26)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Dec 2019
                            <span>(7)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Nov 2019
                            <span>(0)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Oct 2019
                            <span>(0)</span></a></li>
                        <li><a href="#"><i className="linearicons-calendar-text" />Sept 2019
                            <span>(0)</span></a></li>
                      </ul>
                    </aside>
                  </div>
            ...
            <div className="container">
              ...
              <div className="row related_post_inner">
                <div className="col-lg-4 col-md-6">
                  <div className="small_l_blog_item">
                    <div className="l_blog_img">
                      <img className="img-fluid" src="assets/images/blog/related-post/post-1.jpg" alt="" />
                    </div>
                    <div className="l_blog_text">
                      <div className="date">
                        <a href="#"><i className="linearicons-calendar-full" /> Apr 11, 2020</a>
                        <a href="#"><i className="linearicons-bubbles" /> 39</a>
                      </div>
                      <a href="#">
                        <h3>What is an underlying health condition?</h3>
                      </a>
                      <a className="text_btn" href="#">Read more <i className="linearicons-arrow-right" /></a>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
                  <div className="small_l_blog_item">
                    <div className="l_blog_img">
                      <img className="img-fluid" src="assets/images/blog/related-post/post-2.jpg" alt="" />
                    </div>
                    <div className="l_blog_text">
                      <div className="date">
                        <a href="#"><i className="linearicons-calendar-full" /> Apr 11, 2020</a>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="small_l_blog_item">
                    <div className="l_blog_img">
                      <img className="img-fluid" src="assets/images/blog/related-post/post-3.jpg" alt="" />
                    </div>
                    <div className="l_blog_text">
                      <div className="date">
                        <a href="#"><i className="linearicons-calendar-full" /> Apr 11, 2020</a>
          ...
          <section className="check_now_area check_now_box full_widget_check">
            <div className="container">
              <div className="row m-0 justify-content-between">
                ...
                <div className="right">
                  <a className="icon_btn" href="#">Check now <i className="linearicons-arrow-right" /></a>
                </div>
              </div>
            </div>
          </section>
                ...
                <div className="row">
                    ...
                    <aside className="f_widget contact_widget">
                      ...
                      <div className="ct_wd_text">
                        ...
                        <div className="media">
                          ...
                          <div className="media-body">
                            <a href="http://paul-themes.com/cdn-cgi/l/email-protection#11637e727a6873752028282451767c70787d3f727e7c">
                              <h6>Email: <span><span className="__cf_email__" data-cfemail="325a5b7257425b56575f5b511c5d4055">[email&nbsp;protected]</span></span></h6>
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6 col-6">
                    <aside className="f_widget list_widget">
                      ...
                      <ul className="nav flex-column">
                        <li>
                          <a href="#"><i className="linearicons-radio-button" />Typical
                            Symptoms</a>
                        </li>
                        <li>
                          <a href="#"><i className="linearicons-radio-button" />How to
                            Protect</a>
                        </li>
                        <li>
                          <a href="#"><i className="linearicons-radio-button" />How are
                            spreading</a>
                        </li>
                        <li>
                          <a href="#"><i className="linearicons-radio-button" />Meet our
                            Doctors</a>
                        </li>
                        <li>
                          <a href="#"><i className="linearicons-radio-button" />About
                            Coronavirus</a>
                        </li>
                      </ul>
                    </aside>
        ...
        <div className="modal fade search_modal" id="exampleModal" tabIndex={-1} role="dialog" aria-hidden="true">
              ...
              <div className="modal-body">
                <div className="input-group">
                  ...
                  <div className="input-group-append">
                    <button className="btn btn-outline-secondary" type="button"><i className="linearicons-magnifier" /></button>
                  </div>
                </div>
              </div>
            </div>
