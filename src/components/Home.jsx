          ...
          <section className="sidebar_widget scroll_body">
            <div className="info_sidebar_inner">
              ...
              <div className="info_title">
                <h2>Get in touch</h2>
                <p>
                  If you have any question before we start, please fill below
                  the contact form.
                </p>
              </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="app_text">
                    ...
                    <p>
                      Download our app now, track Coronavirus cases real-time
                      and follow instant updates.
                    </p>
                    <a className="wow fadeIn" data-wow-delay={400} href="#">
                      <img src="assets/images/apple-btn.png" alt="" />
                    </a>
                    <a className="wow fadeIn" data-wow-delay={500} href="#">
